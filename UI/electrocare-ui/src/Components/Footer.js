      ...
      <Container>
        <div className='row justify-content-between'>
          <div className='col-12 col-md-3 row justify-content-start'>
            <img src={logo} alt="logo" width="100px" className='col-6' />
          ...
          <div className='col-12 col-md-3 align-self-center'>
            ...
            <div className='row'>
              <a href="/" className="text-decoration-none text-light mb-2">Electrical Repairs</a>
              <a href="/" className="text-decoration-none text-light mb-2">Installations</a>
              <a href="/" className="text-decoration-none text-light mb-2">Maintenance</a>
              <a href="/" className="text-decoration-none text-light mb-2">Emergency Services</a>
              <a href="/" className="text-decoration-none text-light mb-2">Home Automation</a>
            </div>
          </div>
          ...
          <div className='col-12 col-md-3 align-self-center'>
            ...
            <div className='row'>
              <a href="/" className="text-decoration-none text-light mb-2">About Us</a>
              <a href="/" className="text-decoration-none text-light mb-2">FAQ</a>
              <a href="/" className="text-decoration-none text-light mb-2">Become Partner</a>
              <a href="/" className="text-decoration-none text-light mb-2">Career</a>
              <a href="/" className="text-decoration-none text-light mb-2">Terms & Policies</a>
            </div>
          </div>
          ...
          <div className='col-12 col-md-3 align-self-center'>
            ...
            <div className='row'>
              <a href="/" className="text-decoration-none text-light mb-4">
