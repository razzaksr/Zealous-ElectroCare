            ...
            <Container>
                <div className="m-5">
                    ...
                    <div className="row justify-content-evenly">
                        <Card className="col-3 me-1 rounded-3 shadow">
                ...
                <div className="m-5">
                    ...
                    <div className="row justify-content-evenly">
                        <Card className="col-3 me-1 rounded-3 shadow text-light" style={{background: 'linear-gradient(to right, var(--bs-green), var(--bs-blue))'}}>
                ...
                <div className="m-5">
                    ...
                    <div className="row justify-content-around">
                        ...
                        <div className="col-1">
                            <h1 className="display-6 text-success text-success"><span className="bi bi-chevron-double-right"></span></h1>
                        </div>
                        <div className="col-3">
                            <div className="alert alert-primary rounded-5 text-center">
                                <h3>2</h3>
                        ...
                        <div className="col-1">
                            <h1 className="display-6 text-success"><span className="bi bi-chevron-double-right"></span></h1>
                        </div>
                        <div className="col-3">
                            <div className="alert alert-primary rounded-5 text-center">
                                <h3>3</h3>
            ...
            <div className="text-light w-100" style={{background: 'linear-gradient(to right, var(--bs-green), var(--bs-blue))'}}>
                <div className="m-5 p-5">
                    ...
                    <div className="text-center m-5">
                        <a href="/" className="btn btn-outline-light"><p className="display-6">Book Now</p></a>
                    </div>
                </div>
            </div>
        </>
